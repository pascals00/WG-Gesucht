...
class HTMLInfoExtractor:
    ...
    def update_apartment_data(self, data):
        ...
        try:
            ...
            self.logger.error(f"{self.apartmentID}: Error in update_apartment_data. Message: {e}")
    ...
    def check_ad_is_active(self): 
        ...
        try: 
            ...
            self.logger.error(f"{self.apartmentID}: Error in check_ad_is_active. Message: {e}")
            self.logger.error(traceback.format_exc())
    ...
    def check_id_is_stored(self):
        ...
        try: 
            ...
            self.logger.error(f"{self.apartmentID}: Error in check_id_is_stored. Message: {e}")
            self.logger.error(traceback.format_exc())
    ...
    def extract_rental_information(self):
        ...
        try: 
            title = room_size = total_rent = None
            ...
            data = {'apartmentID' : int(apartmentID), 'title': title, 'room_size': room_size, 'total_rent': total_rent}
            self.update_apartment_data(data)
            return title, room_size, total_rent
        except Exception as e:
            self.logger.error(f"{self.apartmentID}: Error in extract_rental_information. Message: {e}")
            self.logger.error(traceback.format_exc())
    ...
    def extract_address(self):
        ...
        try: 
            ...
            self.logger.error(f"{self.apartmentID}: Error in extract_address. Message: {e}")
            self.logger.error(traceback.format_exc())
    ...
    def extract_online_status(self):
        ...
        try: 
            ...
            self.logger.error(f"{self.apartmentID}: Error in extract_online_status. Message: {e}")
            self.logger.error(traceback.format_exc())
    ...
    def extract_availability(self):
        ...
        try: 
            ...
            self.logger.error(f"{self.apartmentID}: Error in extract_availability. Message: {e}")
            self.logger.error(traceback.format_exc())
    ...
    def extract_costs(self):
        ...
        try:
            ...
            self.logger.error(f"{self.apartmentID}: Error in extract_costs. Message: {e}") 
            self.logger.error(traceback.format_exc())
    ...
    def get_raw_wg_details(self):
        ...
        try: 
            ...
            self.logger.error(f"{self.apartmentID}: Error in get_raw_wg_details. Message: {e}")
            self.logger.error(traceback.format_exc())
    ...
    def clean_wg_details(self, data):
        ...
        try: 
            ...
            self.logger.error(f"{self.apartmentID}: Error in clean_wg_details. Message: {e}")
            self.logger.error(traceback.format_exc())
    ...
    def extract_object_details(self):
        ...
        try: 
            ...
            self.logger.error(f"{self.apartmentID}: Error in extract_object_details. Message: {e}")
            self.logger.error(traceback.format_exc())
    ...
    def write_to_csv(self):
        ...
        try:
            ...
            self.logger.error(f"{self.apartmentID}: Error in write_to_csv. Message: {e}")
            self.logger.error(traceback.format_exc())
